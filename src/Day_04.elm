...
solution =
    let
        ...
        boards =
            input2
                |> List.filterMap fromList


        pullNextNumber : List Int -> Set Int -> Int
        pullNextNumber numbers markedNumbers =
            case numbers of
                head :: tail ->
                    let
                        nextMarkedNumbers =
                    ...
                    in
                    case List.find (checkForWin nextMarkedNumbers) boards of
                        Just winner ->
                            let
                                unmarkedNumbers =
                        ...
                        Nothing ->
                            pullNextNumber tail nextMarkedNumbers

                [] ->
                    Debug.todo "no winners :("
    in
    pullNextNumber input Set.empty
